#ifndef SUMULADO1_H_INCLUDED
#define SUMULADO1_H_INCLUDED
void simulado2(){
                    ...
                    for(i=1;i<=6;i++){
                           ...
                           while(puntosRonda<21 && puntosRondas2<21){
                                ...
                                while(cortar==0){
                                    ...
                                    cout<<"  |  ";cout<<"RONDA: "<<numeroRonda;
                                    cout<<"  |  ";cout<<"PUNTAJE ACUMULADO: "<<puntosTotales2<<endl;
                                    cout<<"- - - - - - - - - - - - - - - - - - - - - - - - - - - -"<<endl;
                                    cout<<" VECES QUE HUBO BUNCO: "<<bunco3<<endl;
                                    cout<<"- - - - - - - - - - - - - - - - - - - - - - - - - - - -"<<endl;
                                    cout<<" LANZAMIENTO: "<<lanzamientos2<<endl;
                                    cout<<"- - - - - - - - - - - - - - - - - - - - - - - - - - - -"<<endl;
                                    cout<<" PUNTAJE DE LA RONDA: "<<puntosRondas2<<endl;
                                    cout<<"- - - - - - - - - - - - - - - - - - - - - - - - - - - -"<<endl;
                                    puntos2= tirarDados(numeroRonda,4);
                                    lanzamientos2++;
                                    if (puntos2!=0){
