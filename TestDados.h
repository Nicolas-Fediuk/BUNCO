...
int MenuPrincipalGenerala() {
    ...
    setColor(YELLOW);
    locate(41, 8); cout << endl;
    locate(41, 9); cout << "1-JUEGO NUEVO PARA UN JUGADOR" << endl;
    locate(41, 10); cout << "2-JUEGO NUEVO PARA DOS JUGADORES" << endl;
    locate(41, 11); cout << "3-MOSTRAR PUNTUACION MAS ALTA"<<endl;
    locate(41, 12); cout << "4-MODO SIMULADO (CARGAR DADOS MANUALMENTE)"<<endl;
    locate(41, 13); cout << "5-MODO SIMULADO DOS JUGADORES (CARGAR DADOS MANUALMENTE)"<<endl;
    locate(41, 14); cout << "6-INSTRUCIONES"<<endl;
    locate(41, 15); cout << "0-FIN DEL PROGRAMA"<<endl;
    locate (41,17);cout<<"OPCION: ";
